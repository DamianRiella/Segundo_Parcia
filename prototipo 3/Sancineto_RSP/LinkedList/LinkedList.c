...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if (this != NULL && nodeIndex >=0 && nodeIndex <= ll_len(this))
    {
        ...
        if (nodeIndex == 0)
        {
            Node* viejoNodo = getNode(this, nodeIndex);
            this->pFirstNode = nuevoNodo;
            nuevoNodo->pNextNode = viejoNodo;
        }
...
void* ll_get(LinkedList* this, int index)
{
    ...
    {
        Node* nuevoNodo = getNode(this,index);
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if (this != NULL && index >=0 && index < ll_len(this))
    {
        Node* viejoNodo = getNode(this, index);
        viejoNodo->pElement = pElement;
        returnAux = 0;
    }
    return returnAux;
}
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if (this != NULL && index >=0 && index < ll_len(this))
    {
        ...
        Node* deletedNode = getNode(this, index);
        Node* nextNode = getNode(this, index+1);
...
void* ll_pop(LinkedList* this,int index)
{
    ...
    if (this != NULL && index >=0 && index < ll_len(this))
    {
        deletedNode = getNode(this, index);
        returnAux = deletedNode->pElement;
    ...
    if (this!= NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        for (i=0; i<ll_len(this)-1; i++)
        {
            for (j=i+1; j<ll_len(this); j++)
            {
                ...
                if ((order && pFunc(pElementUno,pElementDos)>0) || (!order && pFunc(pElementUno,pElementDos)<0))
                {
